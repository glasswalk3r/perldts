...
# :WARNING:15/11/2006:ARFjr: This class is incomplete. There are several properties not defined
# here that exists in the OLE API.

sub use_single_file_7 {

    my ( $self, $write_attemp ) = shift;
    croak "This is a read only method\n" if ( defined($write_attemp) );
