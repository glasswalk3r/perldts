...
BEGIN { use_ok('DTS::Task::ExecutePackage') }
can_ok(
    'DTS::Task::ExecutePackage',
    qw(new get_name get_description get_type get_properties to_string get_package_id get_package_name
